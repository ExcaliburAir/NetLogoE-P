...
to recolor-grass
  set pcolor scale-color green grass-amount 0 (2 * 10)
end
...
"pen-1" 1.0 0 -13840069 true "" "plot count patches with [grass-amount > grass-regrowth-rate]"
"pen-2" 1.0 0 -6459832 true "" "plot count wolves"
